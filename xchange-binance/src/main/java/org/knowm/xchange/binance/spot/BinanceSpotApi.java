...
/**
 * Public Spot market-data endpoints ({@code /api/v3/*}).
 *
 * <p>This interface is the explicit owner of the public Spot REST surface. Authenticated Spot
 * account/order endpoints live in {@link BinanceSpotAuthApi}; wallet/SAPI endpoints live in the
 * wallet family.
 */
@Path("")
