package org.knowm.xchange.binance.usdm;
...
/**
 * Authenticated USDⓈ-M futures endpoints ({@code /fapi/v1*, /fapi/v2*, /fapi/v3*}).
 *
 * <p>This interface is the explicit owner of the authenticated USDⓈ-M (linear) futures surface:
 * account, positions, leverage/margin-mode, orders, trades, commission rates, and the futures
 * user-data listen key. Order placement is non-replayable after an ambiguous transport result.
 */
@Path("")
@Produces(MediaType.APPLICATION_JSON)
public interface BinanceUsdmAuthApi {
  ...
  /**
   * Closes the futures websocket authenticated connection.
   *
   * @return
   * @throws BinanceException
   * @throws IOException
