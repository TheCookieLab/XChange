...
public interface BinanceAuthenticated extends Binance {
  ...
  /**
   * Check an order's status.<br> Either orderId or origClientOrderId must be sent.
   *
   * @param symbol
  ...
  /**
   * Get all account orders; active, canceled, or filled. <br> If orderId is set, it will get orders
   * >= that orderId. Otherwise most recent orders are returned.
   *
   * @param symbol
   * @param orderId    optional
