...
/**
 * Public USDⓈ-M futures market-data endpoints ({@code /fapi/v1/*}).
 *
 * <p>This interface is the explicit owner of the USDⓈ-M (linear) futures public REST surface.
 * Authenticated futures endpoints live in {@link BinanceUsdmAuthApi}; the COIN-M (inverse)
 * surface lives in the coinm family.
 */
@Path("")
@Produces(MediaType.APPLICATION_JSON)
public interface BinanceUsdmApi {
