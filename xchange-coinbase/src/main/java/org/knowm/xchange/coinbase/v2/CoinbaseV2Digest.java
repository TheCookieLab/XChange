...
public class CoinbaseV2Digest extends BaseParamsDigest {
  ...
  private CoinbaseV2Digest(String keyName, String secretKey) throws Exception {
  ...
  public static CoinbaseV2Digest createInstance(String keyName, String secretKey) {
    if (keyName == null || secretKey == null) {
      return null;
    }
    try {
      return new CoinbaseV2Digest(keyName, secretKey);
    } catch (Exception e) {
      throw new IllegalStateException("Failed to initialize CoinbaseV2Digest", e);
    }
  }
