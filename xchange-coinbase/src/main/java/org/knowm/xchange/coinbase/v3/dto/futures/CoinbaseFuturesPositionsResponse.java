...
public class CoinbaseFuturesPositionsResponse {
  ...
  @JsonCreator
  public CoinbaseFuturesPositionsResponse(
      @JsonProperty("positions") List<CoinbaseFuturesPosition> positions) {
    this.positions = positions == null ? null : List.copyOf(positions);
  }
  @Override
