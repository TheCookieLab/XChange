...
/**
 * Stop limit good-til-date order configuration.
 */
@Getter
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class CoinbaseStopLimitStopLimitGtd {
  ...
  @JsonCreator
  public CoinbaseStopLimitStopLimitGtd(
  ...
  public String toString() {
    return "CoinbaseStopLimitStopLimitGtd [baseSize=" + baseSize + ", limitPrice=" + limitPrice
        + ", stopPrice=" + stopPrice + ", endTime=" + endTime
