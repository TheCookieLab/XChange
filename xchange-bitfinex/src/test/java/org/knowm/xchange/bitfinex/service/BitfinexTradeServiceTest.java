...
class BitfinexTradeServiceTest extends BitfinexExchangeWiremock {
  ...
  void open_orders() throws IOException {
    ...
    LimitOrder expected = new LimitOrder.Builder(OrderType.BID, CurrencyPair.BTC_USD)
        .id("129136592506")
  ...
  void open_orders_by_symbol() throws IOException {
    BitfinexOpenOrdersParams params = (BitfinexOpenOrdersParams) tradeService.createOpenOrdersParams();
