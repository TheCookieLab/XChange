...
Set `xchange.version` to the latest release (`1.0.1`) from Central, or use
`1.0.2-SNAPSHOT` with the snapshots repository below.

Add `xchange-core` plus the exchange modules you use:

```xml
<properties>
  <xchange.version>1.0.2-SNAPSHOT</xchange.version>
</properties>
