...
public class OkexAccountService extends OkexAccountServiceRaw implements AccountService {
  ...
  public Map<Instrument, Fee> getDynamicTradingFeesByInstrument(Object... category)
    ...
    if (category != null && category.length > 0 && category[0] instanceof OkexInstType) {
      if (OkexInstType.SPOT.equals(category[0])) {
        return getTradeFeesSPOT();
      } else if (OkexInstType.SWAP.equals(category[0])) {
