...
public class GateioAccountServiceRawTest extends GateioExchangeWiremock {
  ...
  void getWithdrawStatus_valid() throws IOException {
    ...
    GateioWithdrawStatus expected =
        GateioWithdrawStatus.builder()
  ...
  void http_401_exception_mapped() {
    assertThatExceptionOfType(ExchangeSecurityException.class)
        .isThrownBy(
            () -> gateioAccountServiceRaw.getWithdrawStatus(Currency.getInstance("THROW_401")));
    assertThatExceptionOfType(ExchangeSecurityException.class)
        .isThrownBy(
            () -> gateioAccountServiceRaw.getWithdrawStatus(Currency.getInstance("INVALID_KEY")));
  }
  ...
  void http_403_exception_mapped() {
    assertThatExceptionOfType(ExchangeSecurityException.class)
        .isThrownBy(
            () ->
                gateioAccountServiceRaw.getWithdrawStatus(
                    Currency.getInstance("RETURN-FORBIDDEN")));
  }
  ...
  void http_500_exception_mapped() {
    assertThatExceptionOfType(InternalServerException.class)
        .isThrownBy(
            () ->
                gateioAccountServiceRaw.getWithdrawStatus(
                    Currency.getInstance("INTERNAL-SERVER-ERROR")));
  }
  ...
  void invalid_currency_exception_mapped() {
    assertThatExceptionOfType(InstrumentNotValidException.class)
        .isThrownBy(
            () ->
                gateioAccountServiceRaw.getWithdrawStatus(
                    Currency.getInstance("invalid-currency")));
  }
  ...
  void withdrawal_records() throws IOException {
    ...
    GateioWithdrawalRecord expected =
        GateioWithdrawalRecord.builder()
            .id("w35874123")
  ...
  void deposit_records() throws IOException {
    ...
    GateioDepositRecord expected =
        GateioDepositRecord.builder()
            .id("d95198946")
