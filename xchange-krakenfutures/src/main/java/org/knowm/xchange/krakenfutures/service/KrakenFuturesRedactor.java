 ...
 *
 * <p>Kraken Futures provider error strings can echo request parameters such as API keys,
 * signatures, nonces, and withdrawal addresses. All structured failure details in this module pass
 * through {@link #sanitize(String)} before they reach callers.
 */
public final class KrakenFuturesRedactor {
