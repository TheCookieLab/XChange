 ...
 *
 * <p>Emitted when an update arrives whose sequence jumps past the expected next sequence. If {@code
 * recovered} is true the book was rebuilt from a REST snapshot and streaming continues; otherwise
 * the book is stale and subscribers must refetch or resubscribe. The event is the failure surface:
 * a gap is never silently swallowed.
 */
public final class CoinbaseOrderBookGap {
  ...
  public CoinbaseOrderBookGap(
      Instrument instrument, long expectedSequence, long receivedSequence, boolean recovered) {
    this(instrument, expectedSequence, receivedSequence, recovered, System.currentTimeMillis());
  }
  ...
  public boolean equals(Object other) {
    ...
    return expectedSequence == gap.expectedSequence
        ...
        && Objects.equals(instrument, gap.instrument);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instrument, expectedSequence, receivedSequence, recovered);
  }

  @Override
  public String toString() {
    return "CoinbaseOrderBookGap [instrument="
        + instrument
        + ", expectedSequence="
        + expectedSequence
        + ", receivedSequence="
